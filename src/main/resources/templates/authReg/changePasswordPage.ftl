      ...
      <form action=${path} method="post">
        ...
        <#if !isAdmin>
          ...
          <div class="form-group row">
            ...
            <input class="form-control col-sm-4" id="currPsw" name="currentPassword" type="password" placeholder="Current password">
          </div>


          <div class="form-group row">
            <label class="col-sm-2 col-form-label" for="newPsw">New password</label>
            <input class="form-control col-sm-4" id="newPsw" name="newPassword" type="password" placeholder="New password">
          </div>
        ...
        <div class="form-group row">
          ...
          <input class="form-control col-sm-4" id="confirmPsw" name="confirmPassword" type="password" placeholder="Confirm password">
        </div>
